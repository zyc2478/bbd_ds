...
public class QuartzConfiguration {
    ...
    @Bean(name = "jobDetail")
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(BidListJob task) {//ScheduledJob 为定时任务的类
        ...
        jobDetail.setTargetMethod("execute");//scheduleTest 定时任务中要执行的方法
        return jobDetail;
    }
    ...
    public CronTriggerFactoryBean cronJobTrigger(MethodInvokingJobDetailFactoryBean jobDetail) {
        ...
        trigger.setCronExpression("0/5 * * * * ?");// 表示每隔6秒钟执行一次
        //tigger.set
